...
def main():
    with st.form('prediction_form'):
        ...
        accident_cause = st.selectbox("Cause of Accident: ", options=options_cause)
        ...
        lanes = st.selectbox("Lane of Accident: ", options=options_lanes)
    ...
    if submit:
        ...
        data = np.array([hour,day_of_week,casualties,accident_cause,vehicles_involved, vehicle_type,driver_age,accident_area,driving_experience,lanes]).reshape(1,-1)
